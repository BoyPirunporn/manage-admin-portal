  ...
  " aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive ",
  {
    variants: {
      variant: {
        ...
        outline:
          "border cursor-not-allowed shadow-xs hover:bg-accent disabled:hover:bg-red hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        secondary:
          "bg-secondary cursor-pointer text-secondary-foreground shadow-xs hover:bg-secondary/80",
        ghost:
          "hover:bg-accent disabled:hover:bg-red cursor-pointer hover:text-accent-foreground dark:hover:bg-accent/50 disabled:pointer-not-allow",
